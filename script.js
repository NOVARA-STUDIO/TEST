...
const projects = [
    {
        ...
        url: "#project-1",
        preview: "images/cloudsync-preview.jpg", // Змініть на шлях до вашого фото
    ...
    },
    {
        ...
        title: "HealthTracker",
        url: "#project-4",
        preview: "images/health-preview.jpg", // Змініть на шлях до вашого фото
        platforms: ["android", "windows"],
        created: "14.11.2023",
        updated: "20.01.2024",
        downloadUrl: "https://play.google.com/store/apps/details?id=com.novara.healthtracker",
        description: "Комплексний додаток для відстеження здоров'я та фітнесу. HealthTracker допомагає контролювати ваше фізичне здоров'я, харчування та активність.",
        features: [
            "Відстеження активності та кроків",
            "Моніторинг сну",
            "Калькулятор калорій",
            "Планування тренувань",
            "Графіки та статистика прогресу",
            "Інтеграція з носимими пристроями"
        ],
        technologies: ["Flutter", "Dart", "Firebase", "HealthKit", "Google Fit API"],
        screenshots: [
            "images/health-screenshot1.jpg", // Змініть на шлях до вашого фото
            "images/health-screenshot2.jpg"  // Змініть на шлях до вашого фото
        ]
    },
    {
        id: 5,
        title: "PhotoEditor Studio",
        url: "#project-5",
        preview: "images/photo-preview.jpg", // Змініть на шлях до вашого фото
        platforms: ["macos", "windows"],
        created: "03.02.2023",
        updated: "18.01.2024",
        downloadUrl: "https://github.com/novara-studio/photoeditor/releases/latest",
        description: "Професійний фоторедактор для творчих людей. PhotoEditor Studio пропонує потужні інструменти обробки зображень з інтуїтивним інтерфейсом.",
        features: [
            "Неруйнівне редагування",
            "Шари та маски",
            "Більше 100 фільтрів та ефектів",
            "Інструменти ретушування",
            "Пакетна обробка фото",
            "Підтримка RAW-форматів"
        ],
        technologies: ["C++", "OpenCV", "Qt", "GPU Computing", "Metal/DirectX"],
        screenshots: [
            "images/photo-screenshot1.jpg", // Змініть на шлях до вашого фото
            "images/photo-screenshot2.jpg"  // Змініть на шлях до вашого фото
        ]
    },
    {
        id: 6,
        ...
        url: "#project-6",
        preview: "images/music-preview.jpg", // Змініть на шлях до вашого фото
        platforms: ["android", "windows", "macos"],
        created: "27.04.2023",
        updated: "25.01.2024",
        downloadUrl: "https://musicwave.novara-studio.com/download",
        description: "Сучасний музичний плеєр з підтримкою всіх популярних форматів. MusicWave забезпечує найвищу якість звуку та зручне управління музичною бібліотекою.",
        features: [
            "Підтримка Hi-Res Audio",
            "10-смуговий еквалайзер",
            "Візуалізації та теми",
            "Інтеграція з музичними сервісами",
            "Розумні плейлисти",
            "Синхронізація між пристроями"
        ],
        technologies: ["React Native", "Web Audio API", "SQLite", "Redux"],
        screenshots: [
            "images/music-screenshot1.jpg", // Змініть на шлях до вашого фото
            "images/music-screenshot2.jpg"  // Змініть на шлях до вашого фото
        ]
    }
];
